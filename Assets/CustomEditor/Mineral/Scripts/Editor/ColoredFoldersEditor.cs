...
namespace CustomEditor.Mineral.Scripts.Editor
{
    ...
    public static class ColoredFoldersEditor
    {
        ...
        private static void StoreIconGuids()
        {
            ...
            // We should first look for the CustomEditor folder
            string customEditorFolderPath = MineralEditor.FindFolderByName("CustomEditor");

            if(customEditorFolderPath == null || customEditorFolderPath == "")
            {
                Debug.LogError("Mineral : No CustomEditor folder found...");
                return;
            }

            iconsPath = customEditorFolderPath + "/" + Constants.localColoredIconsPath; 
