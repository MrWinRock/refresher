...
using System.IO;
using System.Text;
using CustomEditor.Mineral.Scripts.Data;
using UnityEditor;
using UnityEngine;
...
namespace CustomEditor.Mineral.Scripts.Editor
{
    ...
    public static class MineralEditor 
    {
        ...
        private static void LoadData()
        {
            ...
            string customEditorFolderPath = FindFolderByName("CustomEditor");
            dataPath = customEditorFolderPath + "/" + Constants.localDataPath;
